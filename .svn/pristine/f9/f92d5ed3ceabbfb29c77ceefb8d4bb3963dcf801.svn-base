...
<script type="text/javascript">
	...
	function checkUserName(){
		...
		$("#span1").load("${pageContext.request.contextPath}/usercheckUserName.action?"+new Date().getTime(),{'username':username});
	}
	
	function checkImage(){
		var checkcode = $("#checkcode").val();
		$("#spany1").load("${pageContext.request.contextPath}/spanCheckImage.action?"+new Date().getTime(),{'checkcode':checkcode});
	}
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<font style="font-weight:bold; color:#FF0000">${imerr }</font><br />
					<div class="title">
						<s:actionerror />
					</div>
								...
								<tr>
									...
									<td><span class="fieldSet"> 
										<input type="text"
											...
											maxlength="4" autocomplete="off" onblur="checkImage()" />
											<!-- onmouseout="checkImage() -->
										<img
												id="checkImg" class="captchaImage"
												src="${ pageContext.request.contextPath }/checkImage.action"
