...
body {
  color: white;
  background-image: url("${pageContext.request.contextPath}/image/2211.jpg");
}
</style>
<body>
<form action="${ pageContext.request.contextPath }/cartaddCart.action" method="post">
				...
				<div class="action">
						...
						<dl class="quantity">
							...
							<dd>
								...
								<input  name="pid" value="${product.pid }"  onpaste="return false;" type="hidden">
							</dd>
							<dd>
								件
							</dd>
